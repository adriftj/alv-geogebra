...
(function() {
  ...
  var GGBApplet = function() {
      ...
      var setDefaultHTML5CodebaseForVersion = function(version, offline) {
          ...
          if (index > 0) {
              ...
              codebase = "https://www.geogebra.org/apps/5.2.879.0/"
          }
  ...
  GGBAppletUtils.makeModule = function(name, permutation) {
      function webModule() {
          ...
          A();
          webModule.__moduleBase = "https://www.geogebra.org/apps/5.2.879.0/" + name + "/";
  ...
  if (typeof window.web3d !== "function") {
      window.web3d = GGBAppletUtils.makeModule("web3d", "315D6332DFD582646D91A11BAC012851")
  }
  if (typeof window.webSimple !== "function") {
      window.webSimple = GGBAppletUtils.makeModule("webSimple", "82144720E1CDA2E5E74FD9FE3DBA01DA")
  }
